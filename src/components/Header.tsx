...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-200 font-inter">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              {navItems.map((item) => (
                <button
                  ...
                  className="text-sm text-gray-700 hover:text-indigo-600 font-medium transition-colors duration-200"
                >
                  {item.label}
                </button>
              ))}
